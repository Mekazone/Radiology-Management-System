...
//check the database if report has been entered, and add link to edit info
	...
	if($query5_numrows != 0)
	{
		echo "<h4><a href='ecg_print_preview.php?id=$id' style='float:right;margin-right:470px;'>Print Preview</a></h4>";
	}
...
if($row4_age >= 365)
{
	...
	echo "<tr><td><b>Radiologist's Diagnosis</b></td><td>$row5_ecg_radiologist_diagnosis</td></tr>";
